...
public abstract class BasePopWindow {
    ...
    public void setDisapperOutside(boolean disapper){
        if(mInstance != null) {
            mInstance.setOutsideTouchable(disapper);
            mInstance.setFocusable(disapper);
        }
    }
    ...
    public void setWindowBackgroundColor(ColorDrawable colorDrawable) {
        mInstance.setBackgroundDrawable(colorDrawable);
    }
