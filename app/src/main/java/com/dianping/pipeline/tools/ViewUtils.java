...
/******************* Following methods are merged from HotelViewUtils.java in android-nova-hotel **********************/
    ...
    /**
     * 设置手机全屏
     * 目前适配了：华为刘海屏手机（华为刘海屏手机不全屏）
     *
     * @param context
     * @param window  应用页面window对象
     */
    public static void setFullScreenWindow(Context context, Window window) {
        if (window != null) {
    ...
    public static boolean hasNotchInScreen(Context context) {
        ...
        try {
            ...
            Log.e("HwFullScreen", "hasNotchInScreen ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            Log.e("HwFullScreen", "hasNotchInScreen NoSuchMethodException");
        } catch (Exception e) {
            Log.e("HwFullScreen", "hasNotchInScreen Exception");
        } finally {
            return ret;
        }
    }
     ...
     * @param activity 当前页面
     */
    public static void hideKeyboard(@NonNull MotionEvent event, @NonNull View view, @NonNull Activity activity) {
        try {
